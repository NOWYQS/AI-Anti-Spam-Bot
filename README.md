...
- 👤 **New-Member Profile Review**: Watches real join transitions and evaluates names, usernames, and the first profile photo; normal users are left untouched and only profiles with clear advertising evidence are muted
